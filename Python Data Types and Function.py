...
# Using the print function, I can print the value of my variables as well as nest another function within the same line to print the type of the variable.